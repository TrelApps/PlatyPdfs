...
try:
    ...
    fileReplaceLinesWith("src/PlatyPdfs.App.Core/Data/CoreData.cs", {
    ...
    fileReplaceLinesWith("PlatyPdfs.iss", {
    ...
    BETA_APP_NAME = "PlatyPdfs (PreRelease)"
    STABLE_APP_NAME = "PlatyPdfs"

    fileReplaceLinesWith("PlatyPdfs.iss", {
        "UninstallDisplayName=\"": f"{BETA_APP_NAME if IS_BETA else STABLE_APP_NAME}\"\n",
    }, encoding="utf-8-sig")

    fileReplaceLinesWith("src/PlatyPdfs.App/app.manifest", {
